...
export const prayerCatalog: DevotionalTemplate[] = [
  {
    ...
    source: "Bakara sûresi, 2/201",
    targetCount: null,
    targetUnit: "count",
    targetUnitLabel: null,
    listDisplay: "name",
    expandedArabicSize: 1,
    contexts: ["protection", "gratitude"],
  },
  {
    ...
    source: "İbrâhîm sûresi, 14/41",
    targetCount: null,
    targetUnit: "count",
    targetUnitLabel: null,
    listDisplay: "name",
    expandedArabicSize: 1,
    contexts: ["forgiveness"],
  },
  {
    ...
    source: "Enbiyâ sûresi, 21/87",
    targetCount: null,
    targetUnit: "count",
    targetUnitLabel: null,
    listDisplay: "name",
    expandedArabicSize: 1,
    contexts: ["forgiveness", "relief"],
  },
];
