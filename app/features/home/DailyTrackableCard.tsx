...
export function DailyTrackableCard({ item, moduleId, complete, expanded, onToggleExpanded, onToggleComplete }: {
  ...
  return (
    <TrackableCardShell
      ...
      summary={<CollapsedCardSummary title={display.text} arabic={display.arabic} targetCount={item.targetCount} targetUnit={item.targetUnit} targetUnitLabel={item.targetUnitLabel} expanded={expanded} onToggle={onToggleExpanded} />}
